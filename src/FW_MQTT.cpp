...
//TODO: Cambiar segun ID que se vaya generando por ahora es 01
const char HOST_MQTT_DEVICE_ID[] = "ESP8266_V01_CHT";   //ID del dispositivo Control Hidroponico Tomates
